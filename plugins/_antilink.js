...
await conn.reply(m.chat, `📎 *¡𝐇𝐄 𝐕𝐈𝐒𝐓𝐎 𝐔𝐍 𝐄𝐍𝐋𝐀𝐂𝐄!*\n\n*${await this.getName(m.sender)} 𝑯𝑬𝒀 𝑰𝑵𝐒𝑬𝑷𝑻𝑶 𝐌𝐀𝐍𝐃𝐀𝐒𝐓𝐄 𝐔𝐍 𝐋𝐈𝐍𝐊 𝐐𝐔𝐄 𝐄𝐒𝐓𝐀 𝐏𝐑𝐎𝐇𝐈𝐁𝐈𝐃𝐎 𝐋𝐎 𝐂𝐔𝐀𝐋 𝐕𝐀𝐒 𝐀 𝐒𝐄𝐑 𝑴𝑨𝑵𝑫𝑨𝑫𝑶 𝑨 𝑽𝑰𝑶𝑳𝑨𝑹 𝑨 𝑻𝑼 𝑴𝑨𝑴𝑰*`, m, rcanal, )
...
} else if (!bot.restrict) return conn.reply(m.chat, `*¡Esta característica está desactivada!*`, m, rcanal, )
}
return !0
